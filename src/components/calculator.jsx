...
const Calculator = () => {
  return (
    <div className='bg-[#391C5A] text-white flex flex-col justify-center items-center pt-8 pb-8 w-72px px-3 font-bold border rounded-md mb-5 sm:mt-5 '>
      {/* input */}
      <div className='bg-white flex justify-center items-center border rounded-md '>
        <input className='p-3 w-72 border-neutral-50 outline-none text-black font-normal text-right border rounded-md' type='search' />
      </div><br></br>
      {/* buttons */}
      <div className='grid grid-cols-4 gap-4 w-72 h-auto p-3'>
